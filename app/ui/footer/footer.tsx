      ...
      <div className="max-w-6xl mx-auto ">
        ...
        <div className="flex justify-between">
          ...
          <div className="w-1/4">
            ...
            <Link href="#about">
              <div className="text-[13px] leading-7 hover:text-customOrange">
                About
              </div>
            </Link>
            <Link href="#service">
          ...
          <div className="w-1/4">
            ...
            <div className="my-5">
              <input
                ...
                className="h-11 rounded-tl-[4px] rounded-bl-[4px] outline-none text-black p-[10px] text-sm w-[80%]"
              />
        ...
        <div className="text-center my-4 flex justify-between items-center">
          <div className="text-xs font-normal">
            {" "}
            © 2024 Work Field. All rights reserved. Design by❤️ Blue Sparing
          </div>
          <div className="text-xs font-bold text-customOrange">
            TOP WEB AND APP DESIGN COMPANY IN INDIA
          </div>
          {/* Social media logos */}
